    ...
    public function run(): void
    {
        ...
        $books = [
            [
                ...
                'category_id' => $categories->where('slug', 'eksakta')->first()?->id ?? $categories->first()->id,
            ...
            [
                ...
                'author_id' => $users->random()->id,
                'category_id' => $categories->where('slug', 'sosial')->first()?->id ?? $categories->first()->id,
            ...
            [
                ...
                'author_id' => $users->random()->id,
                'category_id' => $categories->where('slug', 'teknik')->first()?->id ?? $categories->first()->id,
